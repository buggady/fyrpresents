...
class PaymentDetailsView(views.PaymentDetailsView):
    ...
    def get_context_data(self, **kwargs):
        ...
        temp_total = ctx['order_total']
        temp_shipping = ctx['shipping_charge']
        ctx['order_total_incl_tax'] = temp_total.incl_tax
        ctx['shipping_charge_incl_tax'] = temp_shipping.incl_tax
    ...
    def set_account_allocations(self, allocations):
        allocations = serializers.serialize("json", [allocations])
